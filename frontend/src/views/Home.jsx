...
import { effectiveRoutine, effectiveRoutines, effectiveRoutineId, streakWeeks, lastBW, setsDoneActive } from '../lib/history.js'
...
const onToday = () => {
  ...
  return <div className="narrow">
    <div className="hdr">
      <div><h1>{user ? t('Hi {0}', user.name) : 'openGym'}</h1><div className="sub">{today.toLocaleDateString(displayLocale, {
  weekday: 'long',
  day: 'numeric',
  month: 'long'
})}</div></div>
